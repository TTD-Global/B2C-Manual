...
<TabItem value="Create a new product">

## **Create new product**
โดยจะแบ่งออกเป็น 9 ขั้นตอนดังนี้

<Tabs>
<TabItem value="Product category" label="Product category" default>
...
<TabItem value="Descriptions & highlight" label="Descriptions & highlight">
...
<TabItem value="Guide information" label="Guide information">
...
<TabItem value="Extra information" label="Extra information">
...
<TabItem value="Photo" label="Photo">
...
- **Option setup** กำหนดข้อมูลของ Option มีรายละเอียดดังนี้
    ...
    - *Option setup* ระบุภาษาที่ใช้ หากมีไกด์สามารถกด Switch เพื่อเปิด และระบุเกี่ยวกับภาษาของคู่มือ หรือ Audio Guide ได้
    ...
    - **Meeting point or pickup** ระบุจุดนัดพบหรือการรับส่ง
        ...
        - **Pickup service** เกี่ยวกับจุดนัดรับ
            - **Add Pickup Address** จะมี 2 ตัวเลือก
                ...
                - *Pickup specific places* นัดรับที่โรงแรม หรือสนามบิน ตามที่ระบุอย่างน้อย 2 ตำแหน่ง
    ...
    ![](/img/Product-create-option-add-schedule.png)
        - **Schedule** ตารางเวลา
            ...
            - *Fixed time slots* ช่วงเวลาที่กำหนดตายตัว โดยกด _Add time slot_ เพื่อใช้ในการเพิ่มเวลาที่ต้องการ
                ...
                ![](/img/Product-create-option-weekly.png)
            ...
            - *Exceptions* ไว้กำหนดวัน-เวลาที่เป็นวันหยุดนักขัตฤกษ์
        ...
        - **Capacity** สำหรับกำหนดความจุหรือขีดจำกัดจำนวนผู้เข้าร่วม โดยกำหนดสองช่องคือ
            - *Min # of participants* สำหรับระบุจำนวนผู้เข้าร่วมขั้นต่ำ(กำหนด 1 ต่ำสุดไม่สามารถลดลงมากกว่านี้ได้)
...
<TabItem value="Other info" label="Other info">
    ...
    - **Other info** กำหนดแบบฟอร์มการจองให้ลูกค้ากรอก  
        ...
        - *Other required info* Other required info จะไม่ได้บังคับเลือก (เมื่อกดเลือกตัวเลือกจะแสดงกล่องเพื่อกรอก hint text หรือสิ่งนี้จำเป็นต้องกรอกใช่หรือไม่ เป็นปุ่มเปิด-ปิด) 
        ...
        - *Custimized other info* หากเลือก Custimized other info ระบบจะแสดง Customized other info ให้กรอก โดยมีให้เลือกระหว่าง Text และ Sigle selection
         ...
         ![](/img/Product-create-option-customized-other-info-custom-single.png)
...
<TabItem value="Filter by status" label="Filter by status">
    ...
    - **Filter by status** มี Status ดังนี้
        - *All product* แสดง Status ของ Product ที่มีทั้งหมด
...
<TabItem value="Filter type" label="Filter type">
    ...
    - **Filter type** แสดงตาม Type ของ Product
        - *Most popular* แสดง Product ที่มีการเลือกไว้ให้อยู่ในหมวดหมู่ Most popular หากยังไม่มีแสดงให้เลือก _Add product_ เพื่อเพิ่ม product ที่ต้องการได้สามารถเลื่อนปรับตำแหน่งที่ต้องการได้ 8 product (โดยหากเกิน 8 product จะแสดง see more เพิ่มเติม)
